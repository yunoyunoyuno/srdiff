...
class Trainer:
    def __init__(self):
        ...
        self.metrc_keys = ['psnr', 'ssim', 'lpips', 'lr_psnr']
        self.firsti_val = True
    ...
    def build_train_dataloader(self):
        ...
        class CustomDataset(Dataset):
            def __init__(self, input_dir, transform_highres=None, transform_lowres=None):
                """
                Args:
                    input_dir (string): Directory with all the images.
                    transform_highres (callable, optional): Optional transform to be applied on a high-resolution image.
                    transform_lowres (callable, optional): Optional transform to be applied on a low-resolution image.
                """
            ...
            def __getitem__(self, idx):
                ...
                return {"img_hr" : high_res_image.squeeze(),
                        "img_lr" : low_res_image.squeeze(),
    ...
    def train(self):
        ...
        train_pbar = tqdm(dataloader, initial=0, total=float('inf'),dynamic_ncols=True, unit='step');
        training_step = 0;
        EPOCHS = 4000;
        while self.global_step < EPOCHS:
